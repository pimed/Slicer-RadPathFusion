...
class ParserStudyDict:
    def __init__(self,studyDict):
        ...
        self.fixed_landmark3_filename   = None
        ...
        self.ADC_segmentation_filename  = None
        self.DWI_filename               = None
        self.CG_segmentation_filename   = None
    ...
    def SetFromDict(self):  
        ...
        try:
            self.fixed_landmark3_filename        = self.dict['fixed-landmarks3']
        except Exception as e:
            print(e)
        ...
        try:
            self.ADC_segmentation_filename     = self.dict['ADC-segmentation']
        except Exception as e:
            print(e)

        try:
            self.CG_segmentation_filename     = self.dict['CG-segmentation']
        except Exception as e:
            print(e)
